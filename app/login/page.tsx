...
export default function Login() {
  ...
  const handleLogin = () => {
    if (email && password) {
      ...
      document.getElementById("loginForm").classList.add("animate-pulse");
      setTimeout(() => {
        router.push("/Service");
      }, 500);
    } else {
      // เอฟเฟกต์เมื่อกรอกข้อมูลไม่ครบ
      const shake = document.getElementById("loginForm");
      shake.classList.add("animate-shake");
      setTimeout(() => {
        shake.classList.remove("animate-shake");
      }, 500);
