...
export default function ReviewPage() {
  ...
  // Animation variants - แก้ไขส่วนนี้โดยลบข้อความแปลกปลอมออก
  ...
  return (
    ...
    <Link
      href="/about"
      className="inline-block px-4 py-2 text-sm font-medium text-black bg-white border border-black rounded-xl shadow-md transition-all duration-300 ease-in-out hover:bg-black hover:text-white hover:scale-105 active:scale-95"
    >
      ຫນ້າ about ກວດສອບຜົນງານ
    </Link>
